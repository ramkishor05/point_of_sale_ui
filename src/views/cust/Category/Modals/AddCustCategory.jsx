...
class AddCustCategory extends Component {
    ...
    _addItem = () => {
        ...
        if (name) {
            this.props.addCustCategory(this.state, this.props.refresh, this._resetInput, this.props.successNotification, this.props.errorNotification);
        } else {
...
const AddModalWrapped = withStyles(styles)(AddCustCategory);
