...
class AddCustCategoryGroup extends Component {
    ...
    _addCustCategoryGroup = () => {
        const {name} = this.state;

        if (name) {
            this.props.addCustCategoryGroup(this.state, this.props.refresh, this._resetInput, this.props.successNotification, this.props.errorNotification);
        } else {
                            ...
                            <RegularCard
                                ...
                                footer={
                                    <Button
                                        ...
                                        onClick={this._addCustCategoryGroup}>Add</Button>
                                }
                            />
                        </ItemGrid>
                    </Grid>
...
const AddModalWrapped = withStyles(styles)(AddCustCategoryGroup);
