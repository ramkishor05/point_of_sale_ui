...
const mapStateToProps = state => {
    ...
    const { GlobalCategoryGroupList, show_global_category_loader } = state.GlobalCategoryGroupList;

    return { user, GlobalCategoryGroupList, show_global_category_loader };
};
