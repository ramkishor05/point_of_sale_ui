...
export default (state = INITIAL_STATE, action) => {
    switch(action.type) {
        case GET_ALL_CUST_PRODUCTS_SUCCESS:
            return { ...state, custProducts: action.payload, show_cust_product_loader: false };
        ...
        case GET_FINISHING_CUST_PRODUCTS:
            return { ...state, show_cust_product_loader: false, custProducts_finishing: action.payload };
